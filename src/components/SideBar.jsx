...
const SideBar = () => {
	...
	return (
		<aside className="w-30 m-0 flex-col bg-gray-900 text-white rounded-xl px-3 py-3 shadow-slate-700 shadow-lg sidebar-hight sticky top-3">
			...
			<SideBarIcon
				...
				epoint="/portfolio"
			/>
			<SideBarIcon icon={<GiSpellBook size="30" />} tip="blog" epoint="/blog" />
			<SideBarIcon
